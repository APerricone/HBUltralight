...
#define SELF_RENDERER()  (ULRenderer)hb_itemGetPtr( hb_itemArrayGet(hb_stackSelfItem(),ultralight_renderer.ptrObj) )
...
#define SELF_BITMAP()    (ULBitmap) hb_itemGetPtr( hb_itemArrayGet(hb_stackSelfItem(),ultralight_bitmap.ptrObj) )
